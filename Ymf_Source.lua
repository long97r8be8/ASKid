...
local A =
    z:MakeWindow(
    {
        Name = "Blox Fruit (LongX Hub)",
        IntroEnabled = false,
        IntroText = "LongX Hub Library",
        IntroIcon = "rbxassetid://18871428100",
        HidePremium = false,
        SaveConfig = false,
...
function SaveSettings2()
    ...
    writefile("Adel Hub/" .. bN, HttpService:JSONEncode(bM))
end
function ReadSetting2()
    local s, o =
        ...
        function()
            ...
            return HttpService:JSONDecode(readfile("Adel Hub/" .. bN))
        end
    )
    if s then
        return o
